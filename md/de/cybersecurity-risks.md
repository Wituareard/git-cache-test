...
Dies könnte volle Kontrolle über diese Maschinen geben und dem Angreifer ermöglichen, Daten zu stehlen, die Hardware für eigene Berechnungen zu nutzen, den Inhalt zu verschlüsseln, um Lösegeld zu erpressen, oder [die Maschine vollständig zu deaktivieren](https://en.wikipedia.org/wiki/Hardware_Trojan).
