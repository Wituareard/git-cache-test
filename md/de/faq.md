...
Sie können uns auch unter [joep@pauseai.info](mailto:joep@pauseai.info) kontaktieren.

## Haben Sie nicht einfach Angst vor Veränderungen und neuer Technologie? {#haben-sie-nicht-einfach-angst-vor-veraenderungen-und-neuer-technologie}

Sie könnten überrascht sein, dass die meisten Menschen bei PauseAI sich selbst als Techno-Optimisten betrachten.
Viele von ihnen sind in die KI-Entwicklung involviert, sind Gadget-Liebhaber und waren größtenteils sehr aufgeregt über die Zukunft.
...
## Wollen Sie alle KI verbieten? {#wollen-sie-alle-ki-verbieten}
...
## Glauben Sie, dass GPT-4 uns töten wird? {#glauben-sie-dass-gpt-4-uns-toeten-wird}

Nein, wir denken nicht, dass [aktuelle KI-Modelle](/sota) eine existenzielle Bedrohung darstellen.
Es scheint wahrscheinlich, dass die meisten nächsten KI-Modelle auch keine existenzielle Bedrohung darstellen werden.
...
## Kann eine Pause nach hinten losgehen und die Dinge schlimmer machen? {#kann-eine-pause-nach-hinten-losgehen-und-die-dinge-schlimmer-machen}

Wir haben diese Bedenken in [diesem Artikel](/mitigating-pause-failures) angesprochen.

## Ist eine Pause überhaupt möglich? {#ist-eine-pause-ueberhaupt-moeglich}
...
## Wer zahlt Ihnen? {#wer-zahlt-ihnen}

Praktisch alle unsere Aktionen bisher wurden von Freiwilligen durchgeführt.
Allerdings ist PauseAI seit Februar 2024 eine [registrierte gemeinnützige Stiftung](/legal), und wir haben mehrere Spenden von Einzelpersonen erhalten.
...
## Was sind Ihre Pläne? {#was-sind-ihre-plaene}
...
## Wie denken Sie, dass Sie die Regierungen davon überzeugen können, KI zu pausieren? {#wie-denken-sie-dass-sie-die-regierungen-davon-ueberzeugen-koennen-ki-zu-pausieren}

Überprüfen Sie unsere [Theorie des Wandels](/theory-of-change) für eine detaillierte Übersicht über unsere Strategie.

## Warum protestieren Sie? {#warum-protestieren-sie}

- Protestieren zeigt der Welt, dass wir uns um diese Angelegenheit kümmern. Indem wir protestieren, zeigen wir, dass wir bereit sind, unsere Zeit und Energie aufzubringen, um die Menschen zum Zuhören zu bringen.
...
## Wie wahrscheinlich ist es, dass superintelligente KI sehr schlechte Ergebnisse verursacht, wie das menschliche Aussterben? {#wie-wahrscheinlich-ist-es-dass-superintelligente-ki-sehr-schlechte-ergebnisse-verursacht-wie-das-menschliche-aussterben}
...
Es gibt jedoch möglicherweise eine Selektionsverzerrung: Menschen, die im Bereich der KI-Sicherheit arbeiten, tun dies wahrscheinlich, weil sie glauben, dass die Verhinderung von schlechten KI-Ergebnissen wichtig ist.
...
## Wie lange haben wir noch, bis superintelligente KI entsteht? {#wie-lange-haben-wir-noch-bis-superintelligente-ki-entsteht}
...
## Wenn wir pausieren, was ist mit China? {#wenn-wir-pausieren-was-ist-mit-china}
...
## OpenAI und Google sagen, dass sie reguliert werden wollen. Warum protestieren Sie gegen sie? {#openai-und-google-sagen-dass-sie-reguliert-werden-wollen-warum-protestieren-sie-gegen-sie}
...
## Drängen KI-Unternehmen die existenzielle Risiko-Erzählung, um uns zu manipulieren? {#draengen-ki-unternehmen-die-existenzielle-risiko-erzaehlung-um-uns-zu-manipulieren}
...
Lassen Sie uns die Zeitachse betrachten.
...
Er schrieb über existenzielles KI-Risiko [bereits 2015 auf seinem privaten Blog](https://blog.samaltman.com/machine-intelligence-part-1), bevor er OpenAI gründete.
...
Er drängte die existenzielle Risiko-Erzählung nicht, er vermied sie aktiv.
...
Also sehen wir es so, dass die KI-Unternehmen die existenzielle Risiko-Erzählung nicht vorantreiben, sondern reagieren, wenn andere sie vorantreiben, und mit ihrer Antwort warten, bis es absolut notwendig ist.
...
Wie viele strenge Regulierungen und negative Aufmerksamkeit laden sich die Unternehmen durch das Eingeständnis dieser Gefahren auf?
...
## Okay, ich will helfen! Was kann ich tun? {#okay-ich-will-helfen-was-kann-ich-tun}

Es gibt viele [Dinge, die Sie tun können](/action).
Sie können auf eigene Faust einen [Brief](/writing-a-letter) schreiben, [Flyer](/flyering) verteilen, [lernen](/learn) und andere informieren, sich einem [Protest](/protests) anschließen oder [spenden](/donate).
