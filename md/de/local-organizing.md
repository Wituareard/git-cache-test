...
---
title: 'Eine lokale PauseAI-Community leiten: Ein Leitfaden für lokales Organisieren'
...
## Warum ist lokales Organisieren wichtig? {#why-is-local-organizing-important}

Lokales Organisieren – die Zusammenarbeit mit Gruppen von Freiwilligen in lokalen Gemeinschaften, um eine Sache voranzutreiben – ist das Herz und die Seele der PauseAI-Bewegung.
...
Effektives lokales Organisieren kann viel wirkungsvoller sein als ineffektives lokales Organisieren. Wir haben gesehen, welche Auswirkungen effektives Organisieren haben kann, wie es von Graswurzelbewegungen gezeigt wurde, die den Lauf der Geschichte verändert haben. Mit anderen Worten, es ist wichtig, dies richtig zu machen.
...
## Eine lokale Kampagne entwickeln {#developing-a-local-campaign-plan}
...
Wie werden Sie diese Ziele erreichen, wenn Sie rückwärts arbeiten? Das sind Ihre Taktiken.
...
- Veranstaltungen mit der Zustimmung der Freiwilligen planen.
...
Die Verbreitung des Wortes über Ihre Gruppe im Internet kann Ihnen helfen, Zielgruppen leichter zu erreichen.
...
Das Verteilen von Flyern bedeutet, Passanten Flyer mit mehr Informationen über PauseAI und darüber, wie man sich einbringen kann, zu überreichen. Das Aufstellen von Tischen ist ähnlich, aber Sie haben eine sichtbarere Präsenz (und Sie können sich setzen).
...
- mit einer "Aufforderung" und einigen nächsten Schritten enden. Diese "Aufforderung" kann das Anfordern eines Treffens zur Besprechung einer Zusammenarbeit im Detail, das Anfordern der Weitergabe von Informationen über PauseAI an die Liste der Freiwilligen der Gruppe, das Anfordern eines Vortrags bei einer bevorstehenden Gruppensitzung usw. umfassen.
...
Genau wie fossile Brennstoffunternehmen Bemühungen zur Reduzierung der Emissionen untergraben, finanzieren auch KI-Unternehmen Bemühungen, um menschliches Niveau in der KI so schnell wie möglich zu erreichen, obwohl Experten [zugeben](https://blog.aiimpacts.org/p/2023-ai-survey-of-2778-six-things), dass diese Systeme die Zivilisation bedrohen könnten. Diese Angelegenheit hängt direkt mit dem Klimarisiko zusammen, da KI-Trainingsläufe große Mengen an Energie erfordern, die oft aus fossilen Brennstoffen stammen.
...
Können Sie unsere Informationen an Ihre Liste der Freiwilligen weitergeben? Nachfolgend finden Sie einen Link zu unserer öffentlichen Seite. Ich wäre auch gerne bereit, einen Anruf zu planen und dies weiter zu besprechen.
...
### Sprechen bei Gruppensitzungen {#speaking-at-group-meetings}
...
Dies wird wahrscheinlich später erfolgen – nachdem Sie einige E-Mails mit den Gruppenleitern ausgetauscht haben –, kann aber eine wirkungsvolle Möglichkeit sein, Ihre Botschaft zu verbreiten.
...
- **Lösung**: Wie können wir das Problem lösen? (Dieser Abschnitt ist mehr auf die große Vision und weniger auf spezifische Taktiken ausgerichtet.)
  - Beispiel: Wir brauchen ein globales Moratorium für die Entwicklung von Grenz-KI, um zu verhindern, dass Unternehmen so schnell wie möglich menschliches Niveau in der KI erreichen und um uns mehr Zeit zu geben, herauszufinden, wie wir diese Systeme sicher machen können.
- **Strategie**: Wie erreichen wir unsere vorgeschlagene Lösung? Was hat unsere Gruppe zu bieten, um diese Lösung zu ermöglichen?
  - Beispiel: Wir müssen öffentliche Unterstützung und die Zustimmung gewählter Amtsträger für ein Moratorium aufbauen. Wir können dies erreichen, indem wir die Öffentlichkeit über die Risiken von KI aufklären und direkt mit gewählten Amtsträgern sprechen.
...
3. Bitten Sie den Professor, Informationen über Ihr PauseAI-Kapitel an seine Klasse weiterzugeben
...
Könnten Sie die nachfolgende Nachricht an Ihre Studenten oder andere Interessierte weitergeben?
...
Zu Beginn ist es wichtig, sich mit neuen Freiwilligen zu treffen, die gerade bei PauseAI anfangen. Diese ersten Treffen haben mehrere wichtige Ziele:

- Lernen Sie die Freiwilligen auf individueller Ebene kennen; verstehen Sie ihre Interessen und Motivationen, sich PauseAI anzuschließen.
- Bieten Sie zusätzlichen Kontext und teilen Sie eine Vision dessen, was Ihre lokale Gruppe erreichen möchte.
- Bestimmen Sie, an welchen Arten von Arbeiten sich die Freiwilligen einbringen möchten und in welcher Funktion.
- Überzeugen Sie die Freiwilligen von bestimmten Rollen und Verantwortlichkeiten, basierend auf ihren Interessen.

Das Gesamtziel besteht darin, aus diesen Treffen mit 1) einem klaren Verständnis der Rolle und Verantwortung jedes Freiwilligen und 2) spezifischen nächsten Schritten, die die Freiwilligen unternehmen können, hervorzugehen.

### Teamweite Sitzungen {#team-wide-meetings}

Zusätzlich zu Einzelgesprächen mit bestimmten Freiwilligen ist es wichtig, die gesamte Gruppe regelmäßig zusammenzubringen.
...
Eine gute Sitzung sollte sowohl 1) die Ziele und Initiativen der Gruppe und wie sich die Freiwilligen einbringen können, abdecken als auch 2) den Freiwilligen den Raum geben, ihre Perspektive zu teilen und neue Ideen bereitzustellen.

Eine gute Sitzung erfordert [gute Moderation](https://activisthandbook.org/organising/facilitating). Dazu gehören:

- Festlegen von Standards für die Entscheidungsfindung – klare Erwartungen darüber, wie Entscheidungen darüber getroffen werden, was als Gruppe zu tun ist. (Muss es einstimmige Zustimmung geben? Mehrheitsentscheid? Oder treffen Sie als Moderator die Entscheidung? Natürlich kann dies von der Bedeutung der Entscheidung abhängen.)
- Regulieren des Diskussionsflusses, um sicherzustellen, dass eine Person die Konversation nicht dominiert und jeder die Gelegenheit hat, seine Perspektiven zu äußern.
- Konzentrieren Sie die Sitzung auf ein Thema gleichzeitig, bis das Problem gelöst ist.
- Halten Sie die Sitzung pünktlich und stellen Sie sicher, dass ein schriftliches Protokoll von Sitzungsnotizen und Entscheidungen geführt wird.
- Stellen Sie der Gruppe offene Fragen, um Ideen weiter zu erkunden, und stellen Sie klärende Fragen, um ein besseres Verständnis dafür zu bekommen, was jemand sagt.

Zusätzliche Sitzungsinstrumente sind:

- **Runden**: Hören Sie von jedem der Reihe nach zu einer bestimmten Frage oder einem bestimmten Thema.
- **Ideenstürme**: Stellen Sie eine klare Frage und ermutigen Sie die Leute, so viele Ideen wie möglich zu entwickeln.
- **Kleine Gruppen oder Paare**: Geben Sie den Leuten die Gelegenheit, ihre Gedanken zu etwas zu ordnen, bevor sie zu einer großen Gruppendiskussion zurückkehren.
...
- **Aktuelle Prioritäten und Strategie besprechen**
  - Was sind die aktuellen Ziele der Gruppe? Beschreiben Sie laufende Projekte und Veranstaltungen, an denen sich die Freiwilligen einbringen können.
...
- **Brainstorming-Sitzung** – Lassen Sie die Freiwilligen Ideen für andere Veranstaltungen und Initiativen teilen, die die Gruppe durchführen kann.
- **Nächste Schritte**
...
Hier ist eine Beispiel-Tabelle von Rollen zur Inspiration:
...
- **Potlucks**: Lassen Sie die Freiwilligen Essen in einem lokalen Park oder Gemeindezentrum teilen.
...
### Öffentliche Bildungs- und Aktionsveranstaltungen zu KI-Risiken {#public-teach-ins-and-action-sessions-on-ai-risk}

Laden Sie Mitglieder der Öffentlichkeit zu einer offenen Sitzung ein, in der sie mehr über KI-Risiken und den Vertragsvorschlag von PauseAI erfahren können, gefolgt von konkreten Aktionen im Zusammenhang mit der Mission von PauseAI.
...
#### Beispiel für eine Veranstaltungsagenda (für eine Aktionsveranstaltung zum Kongress) {#sample-event-agenda-for-an-action-session-on-congressional-outreach}

- **Einführung / geselliges Beisammensein**
- **Präsentationssitzung**
  - Stellen Sie PauseAI vor
  - Besprechen Sie KI-Risiken
  - Beschreiben Sie den Vertragsvorschlag von PauseAI
  - Erklären Sie die Bedeutung des Kongresskontakts
- **Briefschreibsitzung**
...
Ähnlich wie bei einer öffentlichen Bildungsveranstaltung, aber mit einem Dokumentarfilm statt einer Präsentation. Dies kann eine gute Möglichkeit sein, die Öffentlichkeit zu engagieren. Bonuspunkte, wenn Sie Popcorn und Snacks beschaffen.
Genau wie bei einer Bildungsveranstaltung sollten Sie die Teilnehmer auffordern, sofort nach der Vorführung aktiv zu werden, z.B. indem sie ihren Kongressabgeordneten schreiben oder anrufen.
Siehe [hier](/learn) für eine Liste von Videos und Dokumentarfilmen, die Sie in Betracht ziehen sollten.

### Workshops zum Schreiben von Leserbriefen {#letter-to-the-editor-writing-workshops}

Führen Sie die Freiwilligen durch die Schritte, um einen Leserbrief oder Leitartikel an lokale Zeitungen zu schreiben. Dies funktioniert besser mit Freiwilligen, die bereits von der Mission von PauseAI überzeugt sind und die grundlegenden Argumente verstehen, als mit Mitgliedern der Öffentlichkeit.

#### Beispiel für eine Veranstaltungsagenda {#sample-event-agenda}

- **Erklären Sie die Bedeutung der Medienarbeit**
- **Gehen Sie über bewährte Praktiken für das Schreiben an Medienagenturen**
- **Halten Sie eine Schreibsitzung (20-30 Minuten) ab**
  - Bitten Sie die Freiwilligen, Entwürfe von Leserbriefen zu erstellen und Feedback zu den Schriften der anderen zu geben
  - Bitten Sie die Freiwilligen, ihre Leserbriefe an bestimmte Zeitungen zu senden

### Flyer-Verteilung und Tische aufstellen {#flyering--tabling-sessions}

Auch nachdem Sie eine Basis von Freiwilligen haben, können Sie weiterhin Flyer verteilen und [Tische aufstellen](/tabling), um das Wort an die Öffentlichkeit zu verbreiten.
...
Flyer können geändert werden, um QR-Codes zu relevanten Ressourcen wie einem Leitfaden zum Schreiben von Briefen zu enthalten.
...
Wenn Sie kostenlose Räume nutzen, ist es eine gute Etikette, den Raum so zu verlassen, wie Sie ihn vorgefunden haben, und sich bei dem Anbieter zu bedanken. Dies hilft, eine gute Beziehung aufrechtzuerhalten und erhöht die Wahrscheinlichkeit, dass der Raum für zukünftige Nutzung verfügbar ist.
...
- Stellen Sie sicher, dass die Adresse, die Sie den Leuten geben, Anweisungen über die Straßenadresse hinaus enthält, wenn erforderlich. Wenn Sie beispielsweise Tische aufstellen, aber keine genauen Anweisungen zu Ihrem Tisch innerhalb des Gebäudes haben, werden eine überraschend große Anzahl neuer Mitglieder einfach aufgeben. Ein Tischschild (Fotos bei Walmart für 1 $ pro Stück drucken) kann auch erheblich helfen.
- Fügen Sie Veranstaltungen ein soziales Element hinzu. Stellen Sie sicher, dass es Zeit für geselliges Beisammensein und den Aufbau eines Gemeinschaftsgefühls gibt. Fügen Sie der Veranstaltungsagenda unstrukturierte Zeit hinzu, damit sich die Leute vorstellen und miteinander sprechen können.
- Sie können auch rein gesellige Veranstaltungen durchführen – bei denen es keine Agenda oder Präsentation gibt, sondern nur Essen oder Trinken zusammen. Die gelegentliche Durchführung solcher Veranstaltungen kann eine gute Idee sein.
...
## Überwindung von Hindernissen beim lokalen Organisieren {#note-best-practices-for-event-planning}

### Hindernis 1: Schwierigkeiten, Ihre Gruppe in Gang zu bringen {#overcoming-obstacles-in-local-organizing}

Sie haben möglicherweise Schwierigkeiten, Freiwillige zu finden. Vielleicht scheinen die Leute, mit denen Sie sprechen, nicht interessiert zu sein, Ihre Flyer-Verteilungssitzungen verlaufen nicht gut, und Sie können anscheinend keine bestehenden lokalen Gruppen dazu bringen, Ihre E-Mails zu beantworten.
...
- Wenn Gruppen nicht auf Sie zurückkommen, werfen Sie vielleicht nicht ein breites genug gefächertes Netz aus. Ziehen Sie in Betracht, sich an mehr Gruppen zu wenden, auch wenn ihr Fokus nur lose oder tangential mit KI zusammenhängt.
...
- Die ersten Treffen mit Freiwilligen mögen vielleicht keine klare Vorstellung davon vermitteln, was ihre Rollen und Verantwortlichkeiten sein könnten. In diesem Fall können Sie zusätzliche Einzelgespräche planen und tiefer in diese Fragen eintauchen. Das Ziel dieser zusätzlichen Einzelgespräche sollte sein, das Verständnis dafür zu festigen, wie sich jeder Freiwillige einbringen kann, und einen spezifischen Nachbereitungsplan zu erstellen, um die Rechenschaftspflicht sicherzustellen.
- Wenn Team-Sitzungen "zu viel Gerede und nicht genug Aktion" sind, müssen Sie möglicherweise die Sitzungsagenda umstrukturieren, um mehr Zeit am Ende für konkrete Planung einzuplanen. Bitten Sie die Freiwilligen, im Raum herumzugehen und aufzulisten, was sie vor der nächsten Sitzung tun werden.

- Es hilft auch, zwischen den Sitzungen mit den Freiwilligen Kontakt aufzunehmen, um zu sehen, wie es ihnen mit ihren Verantwortlichkeiten geht, und ob sie Fragen haben oder Hilfe bei etwas benötigen. Dies kann sogar nur eine schnelle Kontrollnachricht sein.

### Hindernis 3: Ihre Gruppe "verpufft" aufgrund nachlassenden Interesses der Freiwilligen {#obstacle-2-lack-of-focus}

Freiwillige sind möglicherweise anfangs begeistert, sich einzubringen, verlieren aber im Laufe der Zeit das Interesse.
Dies kann passieren, weil sich die Freiwilligen nicht motiviert fühlen, die Aktionen, die sie interessieren, nicht mögen oder einfach erkennen, dass ehrenamtliche Arbeit nichts für sie ist.

Einiges davon ist unvermeidlich – nicht jeder wird zu allen Zeiten investiert bleiben –, aber vieles kann vermieden werden.

**Wie man es überwindet**:

- Stellen Sie sicher, dass sich die Freiwilligen befähigt und handlungsfähig fühlen. Freiwillige müssen das Gefühl haben, dass sie einen Anteil an dem haben, was passiert, und dass ihre Einsicht wichtig ist. Dies ist ein weiterer Grund, warum Einzelgespräche so wichtig sind; Sie können die Motivationen der Freiwilligen verstehen und entsprechend mit ihnen arbeiten. Ebenso sollten Sie während der Team-Sitzungen immer genügend Zeit einplanen, damit die Freiwilligen Ideen vorschlagen und Feedback zu Plänen geben können.
- Machen Sie gemeinsam Spaß. Gesellige Veranstaltungen können eine großartige Möglichkeit sein, ein Gemeinschaftsgefühl unter Ihren Freiwilligen aufzubauen.
- Stellen Sie sicher, dass sich die Freiwilligen mit Aktionen einbringen, die sie tatsächlich genießen. Lassen Sie nicht die Person, die Proteste organisiert, Leitartikel schreiben und die Person, die gerne schreibt, Proteste organisieren. Passen Sie Aufgaben an die Personen an, die sich dafür interessieren.
...
Wenn Sie bei irgendeinem Aspekt des lokalen Organisierens Schwierigkeiten haben, können Sie dies auch im local-organizers-Kanal auf dem [PauseAI-Discord](https://discord.gg/2XXWXvErfA) besprechen, und andere werden Ihnen gerne helfen und Feedback geben.