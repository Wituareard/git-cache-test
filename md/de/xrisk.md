...
Sie können auf dieser Seite mehr über existenzielle Risiken erfahren oder sich auch über [Videos, Artikel und weitere Medien](/learn) informieren.

## Experten schlagen Alarm {#experten-schlagen-alarm}

KI-Forscher glauben im Durchschnitt, dass es eine 14-prozentige Chance gibt, dass eine superintelligente KI (eine KI, die wesentlich intelligenter ist als Menschen) zu "sehr schlechten Ergebnissen (z.B. menschlicher Aussterben)" führen wird, sobald wir sie entwickeln.
...
Ein Brief, der zum Stopp der KI-Entwicklung aufruft, wurde im April 2023 veröffentlicht und wurde über 33.000 Mal unterzeichnet, darunter von vielen KI-Forschern und Tech-Unternehmern.
...
- **Yoshua Bengio**, Pionier des Deep Learning und Turing-Preisträger: ["... eine fehlgeleitete KI könnte für die gesamte Menschheit gefährlich sein [...] ein Verbot leistungsfähiger KI-Systeme (sagen wir jenseits der Fähigkeiten von GPT-4), die Autonomie und Handlungsfähigkeit besitzen, wäre ein guter Anfang"](https://yoshuabengio.org/2023/05/22/how-rogue-ais-may-arise/)
...
Sogar die Führungskräfte und Investoren der KI-Unternehmen selbst warnen uns:
...
- **Jaan Tallinn** (Hauptinvestor von Anthropic): ["Ich habe niemanden in KI-Labors getroffen, der sagt, dass das Risiko [durch die Ausbildung eines nächsten Modells] weniger als 1% beträgt, die Welt zu zerstören. Es ist wichtig, dass die Menschen wissen, dass Leben riskiert werden"](https://twitter.com/liron/status/1656929936639430657)

Die Führungskräfte der drei Top-KI-Labors und Hunderte von KI-Wissenschaftlern haben im Mai 2023 die folgende Erklärung unterzeichnet:
...
- [In andere Computer eindringen](/cybersecurity-risks), einschließlich aller Smartphones, Laptops, Serverfarmen usw. Sie könnte die Sensoren dieser Geräte als ihre Augen und Ohren verwenden und überall digitale Sinne haben.
...
## Warum die meisten Ziele schlechte Nachrichten für die Menschheit sind {#warum-die-meisten-ziele-schlechte-nachrichten-für-die-menschheit-sind}
...
- **Maximierung ihrer Ressourcen**. Die Nutzung weiterer Computer wird einer KI helfen, ihre Ziele zu erreichen. Zunächst kann sie dies erreichen, indem sie in andere Computer eindringt. Später kann sie entscheiden, dass es effizienter ist, ihre eigenen Computer zu bauen.
...
Dies ist eine KI, die die oben genannten AutoGPT + GPT-4 verwendet und die Anweisung erhält, "die Menschheit zu zerstören".
...
Es ist sowohl ein bisschen lustig als auch beängstigend, eine KI zu sehen, die darüber nachdenkt, wie sie die Menschheit beenden kann.
...
## Die Evolution selektiert Dinge, die gut darin sind, zu überleben {#die-evolution-selektiert-dinge-die-gut-darin-sind-zu-überleben}
...
Der menschliche Geist neigt dazu, auf Risiken, die unsichtbar, langsam und schwer zu verstehen sind, unterzureagieren.
...
Leider wissen sie nicht, wie sie dies tun sollen, und sie werden durch verschiedene Anreize gezwungen, schneller zu machen, um als Erste AGI zu erreichen.
OpenAIs [Plan](https://openai.com/blog/introducing-superalignment) besteht darin, zukünftige KI-Systeme zu verwenden, um KI auszurichten. Das Problem dabei ist, dass wir keine Garantie haben, dass wir eine KI erstellen, die das Alignment-Problem löst, bevor wir eine KI haben, die katastrophal gefährlich ist.
