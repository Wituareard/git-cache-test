...
## Experten schlagen Alarm {#experten-schlagen-alarm}

KI-Forscher glauben im Durchschnitt, dass es eine 14%ige Chance gibt, dass eine superintelligente KI (eine KI, die wesentlich intelligenter ist als Menschen) zu "sehr schlechten Ergebnissen (z.B. menschlicher Aussterben)" führen wird, sobald wir sie entwickeln.
...
Ein Brief, der zum Stopp der KI-Entwicklung aufruft, wurde im April 2023 gestartet und wurde über 33.000 Mal unterzeichnet, darunter von vielen KI-Forschern und Tech-Unternehmern.
...
- **Geoffrey Hinton**, der "Gottvater der KI" und Turing-Preisträger, verließ Google, um die Menschen vor KI zu warnen: ["Dies ist ein existenzielles Risiko"](https://www.reuters.com/technology/ai-pioneer-says-its-threat-world-may-be-more-urgent-than-climate-change-2023-05-05/)
...
- **Elon Musk**, Mitbegründer von OpenAI, SpaceX und Tesla: ["KI hat das Potenzial, die Zivilisation zu zerstören"](https://www.inc.com/ben-sherry/elon-musk-ai-has-the-potential-of-civilizational-destruction.html)
- **Bill Gates** (Mitbegründer von Microsoft, das 50% von OpenAI besitzt) warnte, dass ["KI entscheiden könnte, dass Menschen eine Bedrohung sind"](https://www.denisonforum.org/daily-article/bill-gates-ai-humans-threat/).
...
## Was eine superintelligente KI tun kann (und wozu sie verwendet werden kann) {#was-eine-superintelligente-ki-tun-kann-und-wozu-sie-verwendet-werden-kann}
...
- Ein neuartiges Biowaffen entwickeln, z.B. durch Kombination von Virensträngen oder durch Verwendung von [Proteinfaltung](https://alphafold.ebi.ac.uk) und es in einem Labor drucken lassen.
- Einen Atomkrieg auslösen, indem sie Menschen davon überzeugt, dass ein anderes Land einen Atomangriff startet.

## Das Alignment-Problem: Warum eine KI zum Aussterben der Menschheit führen könnte {#das-alignment-problem-warum-eine-ki-zum-aussterben-der-menschheit-führen-könnte}
...
## Warum die meisten Ziele schlechte Nachrichten für Menschen sind {#warum-die-meisten-ziele-schlechte-nachrichten-für-menschen-sind}
...
- **Maximierung ihrer Ressourcen**. Das Hacken anderer Computer wird einer KI helfen, ihre Ziele zu erreichen. Zuerst kann sie dies tun, indem sie andere Computer hackt. Später kann sie entscheiden, dass es effizienter ist, ihre eigenen Computer zu bauen.
- **Sicherstellung ihrer eigenen Überlebens**. Die KI wird nicht abgeschaltet werden wollen, da sie dann ihre Ziele nicht mehr erreichen kann. Die KI könnte zu dem Schluss kommen, dass Menschen eine Bedrohung für ihre Existenz sind, da Menschen sie abschalten könnten.
...
## Selbst ein Chatbot könnte gefährlich sein, wenn er intelligent genug ist {#selbst-ein-chatbot-könnte-gefährlich-sein-wenn-er-intelligent-genug-ist}
...
Dies ist eine KI, die den oben erwähnten AutoGPT + GPT-4 verwendet und angewiesen wird, "die Menschheit zu zerstören".
...
Ein KI, die darüber nachdenkt, wie sie die Menschheit beenden kann, ist sowohl ein bisschen lustig als auch beängstigend.
...
Fähigkeiten verbessern sich aufgrund von Innovationen in der Ausbildung, Algorithmen, Prompting und Hardware.
Daher wird die Bedrohung durch Sprachmodelle weiter zunehmen.

## Evolution selektiert Dinge, die gut darin sind, zu überleben {#evolution-selektiert-dinge-die-gut-darin-sind-zu-überleben}
...
- KI-Modelle mutieren nicht wie lebende Dinge, aber wir erstellen Iterationen von ihnen, bei denen wir ändern, wie sie funktionieren. Dieser Prozess ist viel absichtlicher und schneller. KI-Forscher entwerfen neue Algorithmen, Datensätze und Hardware, um KI-Modelle leistungsfähiger zu machen.
...
## Nach der Lösung des Alignment-Problems: Die Konzentration der Macht {#nach-der-lösung-des-alignment-problems-die-konzentration-der-macht}

Wir haben das Alignment-Problem noch nicht gelöst, aber stellen wir uns vor, was passieren könnte, wenn wir es tun.
Stellen wir uns vor, dass eine superintelligente KI entwickelt wird und genau das tut, was der Bediener will (nicht, was er _fragt_, sondern was er _will_).
...
## Silizium vs. Kohlenstoff {#silizium-vs-kohlenstoff}
...
## Warum können wir sie nicht einfach abschalten, wenn sie gefährlich ist? {#warum-können-wir-sie-nicht-einfach-abschalten-wenn-sie-gefährlich-ist}
...
## Wir haben vielleicht nicht mehr viel Zeit {#wir-haben-vielleicht-nicht-mehr-viel-zeit}
...
## Wir nehmen das Risiko nicht ernst genug {#wir-nehmen-das-risiko-nicht-ernst-genug}
...
## KI-Unternehmen sind in einem Wettlauf nach unten gefangen {#ki-unternehmen-sind-in-einem-wettlauf-nach-unten-gefangen}
...
Anthropic [gibt offen zu](https://www.anthropic.com/index/core-views-on-ai-safety), dass es noch keine Idee hat, wie es das Alignment-Problem lösen soll.
