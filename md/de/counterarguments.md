...
Dies ist eine Zusammenstellung von Meinungsverschiedenheiten über KI-Gefahren und den Ruf nach einer KI-Pause.
...
## Wenn es verrückte Dinge tut, können wir es einfach abschalten {#well-if-it-starts-doing-crazy-things-we-can-just-turn-it-off}
...
Auch wenn sie keine eigenen Ziele haben und nur Befehle befolgen, wird jemand irgendwann etwas Gefährliches mit ihnen tun.
