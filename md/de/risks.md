...
Sie bietet enormes Potenzial, aber auch eine Vielzahl von ernsthaften Risiken.
...
Voreingenommene Systeme, die in der Strafverfolgung verwendet werden, wie vorhersagende Polizeialgorithmen, könnten zu unfairer Zielsetzung bestimmter Gruppen führen.
...
KI ersetzt nicht nur unsere Muskeln wie die Dampfmaschine, sondern auch unsere Gehirne.
Normale Menschen könnten nichts mehr anzubieten haben, was die Wirtschaft benötigt.
Bildgenerierungsmodelle (die stark auf urheberrechtlich geschütztem Material von professionellen Künstlern trainiert werden) wirken sich bereits [auf die kreative Industrie aus](https://cointelegraph.com/news/artists-face-a-choice-with-ai-adapt-or-become-obsolete).
...
Das technische Wissen, das erforderlich ist, um diese Systeme zu ändern, könnte von vornherein fehlen oder im Laufe der Zeit verloren gehen, da wir immer abhängiger von Technologie werden und die Technologie komplexer wird.
...
Mögliche fixierte Dystopien mit viel Leiden werden _S-Risiken_ genannt und umfassen Welten, in denen fühlende Wesen versklavt und gezwungen werden, schreckliche Dinge zu tun.
