...
Ein Stopp der Entwicklung von Spitzenmodellen (unser [Vorschlag](/proposal)) würde nicht die Modelle stoppen, die heute verwendet werden, um falsche Medien zu erstellen, aber es könnte helfen, zukünftige Spitzenmodelle zu verhindern.
...
Wie im Abschnitt über Falschmeldungen erwähnt, würden unsere Vorschläge nicht alle falschen Medien verhindern, aber sie könnten in gewissem Umfang reduziert werden.
...
Normale Menschen könnten nichts mehr zur Wirtschaft beitragen.
...
Diese Art von Wissen war noch nie so zugänglich, und wir haben keine Sicherheitsvorkehrungen, um mit den möglichen Konsequenzen umzugehen.
...
### Computerviren und Cyberangriffe {#computer-viruses-and-cybersecurity-attacks}
...
Anstatt ein Team von geschickten Sicherheitsexperten/Hackern anzuheuern, um Zero-Day-Exploits zu finden, könnten Sie einfach eine viel billigere KI verwenden, um dies für Sie zu tun. Natürlich könnte KI auch bei der Cyberabwehr helfen, und es ist unklar, auf welcher Seite der Vorteil liegt.
...
Dies wird als das _Alignmentsproblem_ bezeichnet.
...
Das Problem ist, dass wir aufgrund unseres derzeitigen Mangels an Wissen über Bewusstsein und die Natur neuronaler Netze keine Möglichkeit haben, zu bestimmen, ob einige KI-Systeme eine Art von Erfahrung haben und was die Qualität dieser Erfahrungen wäre.
...
Es ist nicht nur so, dass ein Wertefixieren dazu führen könnte, dass wir die besten Arten von Welten nicht erreichen, sondern es könnte auch dazu führen, dass wir in Dystopien enden, die schlimmer sind als das Aussterben und sich durch die gesamte Raumzeit erstrecken könnten.
...
Diese Wesen könnten Menschen, Tiere, digitale Menschen oder andere außerirdische Spezies sein, die die KI im Kosmos finden könnte. Angesichts dessen, wie schwierig wir das Lösen des Alignmentsproblems halten, wie schlecht wir Menschen einander manchmal behandeln, wie schlecht wir die meisten Tiere behandeln und wie wir die derzeitigen KI-Systeme behandeln, scheint eine solche Zukunft nicht so unwahrscheinlich, wie wir hoffen würden.
