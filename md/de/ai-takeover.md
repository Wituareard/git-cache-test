...
Eine Superintelligenz (SI) ist eine Art von KI, die Fähigkeiten besitzt, die diejenigen aller Menschen in fast allen Bereichen übertrifft.
...
Da die Fähigkeiten von KI aufgrund von Innovationen in Trainingsarchitekturen, Laufzeitumgebungen und größeren Skalierungen verbessert werden, können wir erwarten, dass eine KI schließlich Menschen in fast allen Bereichen übertrifft.
...
Das Teilziel der _Kontrollmaximierung_ über die Welt könnte aufgrund von _instrumenteller Konvergenz_ auftreten: die Tendenz von Teilzielen, sich auf Machtübernahme, Selbstbewahrung und Ressourcenerwerb zu konvergieren:
...
- Verwenden Sie bestehende Fabriken, um **Technologie zu bauen, die wir nicht verstehen**, vielleicht sogar unter Verwendung abgeleiteter Kenntnisse der Physik, die uns nicht bewusst sind. Denken Sie an Nanotechnologie, Quantencomputing und Bioengineering.
...
Und selbst wenn die KI, die die Kontrolle übernimmt, unter menschlicher Kontrolle steht, wissen wir nicht, dass die Person, die die KI kontrolliert, die Interessen aller im Sinn hat.
