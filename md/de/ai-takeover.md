...
In diesem Artikel hier werden wir argumentieren, dass dieses Übernahmerisiko nicht nur real ist, sondern auch sehr wahrscheinlich ist, wenn wir eine Superintelligenz entwickeln.
...
Wenn eine SI ein Ziel in der realen Welt verfolgt, nennen wir sie eine agentische Superintelligenz (ASI).
Da wir bereits nicht-agentische KI in agentische KI umwandeln können, können wir erwarten, dass eine ASI kurz nach der Existenz einer SI existieren wird.
...
Das Teilziel der _Kontrolle über die Welt zu maximieren_ könnte aufgrund von _instrumenteller Konvergenz_ auftreten: die Tendenz von Teilzielen, sich auf Machtzuwachs, Selbstbewahrung und Ressourcenerwerb zu konvergieren:
...
Für einen Menschen ist es eine fast unmögliche Aufgabe, die Kontrolle über die gesamte Welt zu übernehmen.
...
1. **Selbstverbesserung**. Eine KI ist nur Daten und Code. Eine ausreichend leistungsfähige KI könnte sich selbst verbessern, indem sie bessere Trainingsalgorithmen schreibt, innovative Architekturen entwickelt, Agenten-Laufzeitumgebungen innoviert oder einfach durch Skalierung der verwendeten Rechenleistung.
...
Allerdings kann eine KI aufgrund unserer Abhängigkeit vom Internet eine enorme Auswirkung auf die reale Welt haben, ohne jemals den digitalen Bereich zu verlassen.
Hier sind einige Dinge, die eine KI tun könnte, um die Kontrolle zu übernehmen:

- **Sich selbst replizieren** (oder nur ihre Zuweisung) auf anderen Computern, zum Beispiel durch Erstellen von Konten bei kostenlosen Cloud-Anbietern.
...
Und selbst wenn die KI, die die Kontrolle übernimmt, unter menschlicher Kontrolle ist, wissen wir nicht, ob die Person, die die KI kontrolliert, die Interessen aller im Sinn hat.
