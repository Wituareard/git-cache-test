...
Viele dieser Vorschläge (einschließlich aller, die von KI-Labors kommen) basieren auf Sicherheitsbewertungen (oder _Evals_): Testen von KI-Modellen vor dem Einsatz.
...
- **Testen auf gefährliche Fähigkeiten ist schwierig**.
...
Oder betrachten Sie AutoGPT, das es einem Modell ermöglicht, sich selbst rekursiv aufzurufen, was bedeutet, dass es für beliebige Zeiträume autonom laufen kann.
