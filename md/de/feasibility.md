...
Das Stoppen der KI-Entwicklung ist nicht unmöglich.
...
Der einfachste Weg, um Vorreitermodelle zu regulieren, ist die [Regulierung der Rechenleistung](https://www.governance.ai/post/computing-power-and-the-governance-of-ai).
...
Wenn Ihre Hauptangst Unternehmen oder Organisationen sind, können wir sie über 1) Gesetze, Vorschriften und Verträge oder 2) öffentliche Meinung, die sie dazu zwingt, sich selbst zu regulieren, kontrollieren.
...
Wenn Sie denken, dass wir eine Regulierung einer einzelnen Regierung erreichen könnten, aber nicht einen multilateralen Vertrag, müssen Sie erkennen, dass Regierungen erkennen können, dass einige unkontrollierbare Technologien eine Gefahr für ihre Bevölkerung darstellen und aus anderen Nationen stammen können.
Die neuen Technologien werden zu einem nationalen Sicherheitsproblem, und die Regierungen werden daran interessiert sein, andere Länder daran zu hindern, sie zu entwickeln.
Außerdem ist es wichtig zu erkennen, dass wir nicht wirklich viele Länder brauchen, um einer Pause zuzustimmen.
In Wirklichkeit kann man eine Pause in der Entwicklung von Vorreitermodellen erreichen, indem man sie nur in den USA (und sogar nur in Kalifornien) verbietet.
China und der Rest der Welt scheinen ziemlich weit zurückzuliegen, und wir sollten uns nicht zu sehr um ihre Zustimmung zu einem Vertrag kümmern.

## Ähnliche historische Fälle {#similar-historical-cases}

Obwohl jeder Beweis für Inkompetenz oder Bosheit unserer Regierungen, Unternehmen und Systeme uns in eine defätistische Denkweise locken kann, in der Koordination zu schwierig ist, die Interessen der Menschen nicht gut vertreten werden und/oder vertreten werden, aber dumm sind, erkennen wir manchmal nicht die Siege, die wir als Zivilisation throughout Geschichte errungen haben.
...
Ob formell oder informell, sie waren in der Geschichte ziemlich häufig, hauptsächlich um Streitigkeiten zu lösen und Menschenrechte zu fördern.
...
Wenn Sie die Idee von Protesten nicht mögen, unternehmen wir auch [andere Aktionen](/action), wie z.B. die direkte Kontaktaufnahme mit [Regierungen](/lobby-tips).

## Besonderheiten von KI {#ai-particular-case}

Wenn Sie denken, dass KI unterschiedlich genug zu diesen Fällen ist (oder sogar wenn Sie es nicht tun), ist es nützlich, ihre besondere Situation zu analysieren.
...
Das ist nicht etwas, das im besten Interesse der egoistischsten Unternehmen, Regierungen und Menschen liegt.
...
Deshalb ist es wichtig, unser Potenzial zum Erfolg nicht auf kurzfristige Ergebnisse zu gründen, sondern immer auf neue Anhänger und Verbündete vorbereitet zu sein und bereit zu sein, Politiker zu führen, um unsere Vorschläge umzusetzen, falls ein Warnschuss passiert.
...
Außerdem könnte sie die Menschen auf die Gefahren vorbereiten, ihnen beibringen, wie man KI ethischer nutzt, und sie sogar davon überzeugen, nicht in Vorreiter- und unsichere Projekte zu investieren oder daran zu arbeiten.
