...
Wenn Sie denken, dass wir die Regulierung einer einzelnen Regierung erreichen könnten, aber nicht einen multilateralen Vertrag, müssen Sie erkennen, dass, wenn Regierungen erkennen, dass einige unkontrollierbare Technologien eine Gefahr für ihre Bevölkerung darstellen und aus anderen Nationen stammen können, die neuen Technologien ein nationales Sicherheitsproblem werden und die Regierungen daran interessiert sind, andere Länder daran zu hindern, sie zu entwickeln.
...
- Das [Montreal-Protokoll](https://de.wikipedia.org/wiki/Montrealer_Protokoll), das die Produktion von FCKWs in allen 197 Ländern verbot und als Folge dazu führte, dass die globalen Emissionen von ozonschädigenden Substanzen seit 1986 um mehr als 99% zurückgegangen sind. Dank des Protokolls heilt das Ozonloch jetzt, und das ist der Grund, warum wir nicht mehr davon hören.
