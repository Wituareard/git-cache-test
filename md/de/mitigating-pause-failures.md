...
Unserer Meinung nach ist die Wahrscheinlichkeit, dass KI katastrophale Risiken [bald](/urgency) verursacht, bereits groß genug, um einen Stopp zu rechtfertigen.
Wie Stuart Russell sagte, sollte man bei einem ungewissen Zeitplan die Aktion wählen, die bei der kürzesten Zeitvorgabe optimal wäre.
...
Außerdem kann es viele Jahre dauern, von Protesten und Lobbyarbeit bis hin zu Überzeugungsarbeit bei Menschen an der Macht, um einen Vertrag in Kraft zu setzen. Nicht zu erwähnen, dass selbst wenn dies nicht der Fall wäre, ein früher Stopp uns Luft verschafft, damit böse Akteure und algorithmische Durchbrüche uns nicht in den Abgrund stürzen.

## Zu kurzer Stopp / nur 6 Monate {#pausing-for-too-short--only-for-6-months}

Der Stopp, den wir vorschlagen, ist von unbestimmter Länge. Wir sollten nicht wieder anfangen, bis es einen ausreichenden Konsens gibt, dass wir wissen, wie man sichere KI entwickeln kann, egal wie leistungsfähig sie ist, und dass wir die Systeme haben, um es sorgfältig und demokratisch zu tun.
Es ist NICHT wie der [sechsmonatige Stopp, den der offene Brief des Future of Life Institute fordert](https://futureoflife.org/open-letter/pause-giant-ai-experiments/).
...
Wenn die Besorgnis über KI weiter steigt und wir einen Stopp erreichen, könnte es zu einer Situation kommen, in der die gesamte KI-Entwicklung tabuisiert oder illegal wird.
...
Vielleicht gibt ein Stopp einer großen Zahl von Unternehmen die Zeit, aufzuholen, was zu einer großen Gruppe von Unternehmen führen könnte, die weniger sicherheitsbewusst sind.
...
Wenn ein Land die KI-Entwicklung stoppt, werden andere Länder weiterhin KI entwickeln.
...
Ein Akteur, von dem einige Menschen glauben, dass er nicht stoppen wird, ist China.
...
> Wenn der Stopp aufgehoben wird, würden diese Hardware-Verbesserungen sofort für die Ausbildung leistungsfähigerer Modelle zu geringeren Kosten verfügbar werden - ein Hardware-Überhang.
...
Wir [schlagen vor](/proposal), die Entwicklung großer, allgemeiner KI-Modelle zu stoppen, die entweder 1) größer als 10^12 Parameter sind, 2) mehr als 10^25 FLOPs für die Ausbildung verwenden oder 3) Fähigkeiten haben, die GPT-4 überschreiten.
...
- Ein nationaler Stopp, der potenziell schlechtere Akteure dazu bringen könnte, als erste AGI zu erreichen
- Ein internationaler Stopp, der nicht ordnungsgemäß durchgesetzt wird, was zu einem ähnlichen Ergebnis führen könnte
