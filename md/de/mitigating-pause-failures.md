...
Wie Stuart Russell sagte, sollte man bei einem unsicheren Zeitplan die Aktion wählen, die bei der kürzesten Zeitbegrenzung optimal wäre.
...
Außerdem kann es viele Jahre dauern, von Protesten und Lobbyarbeit bis hin zu Überzeugungsarbeit bei Menschen an der Macht, um einen Vertrag in Kraft zu setzen. Abgesehen davon, dass selbst wenn dies nicht der Fall wäre, ein früher Stillstand uns Spielraum gibt, damit böse Akteure und algorithmische Durchbrüche uns nicht in den Abgrund stürzen.

## Zu kurzer Stillstand / nur 6 Monate {#pausing-for-too-short--only-for-6-months}

Der Stillstand, den wir vorschlagen, ist von unbestimmter Länge. Wir sollten nicht wieder anfangen, bis es einen breiten Konsens gibt, dass wir wissen, wie man Frontier-KIs sicher entwickeln kann. Technisch und demokratisch gesehen.
...
Aber worum wir bitten, ist eine Pause, bis wir beweisen können, dass KI sicher gebaut werden kann, also sollten wir nicht mit Organisationen enden, die unsichere KI nach dem Ende der Pause bauen.
...
Nicht-Staatsakteure sind unwahrscheinlich, dass sie ausreichende Ressourcen in Geheimheit sammeln können, um ein AGI für mindestens ein Jahrzehnt nachdem AGI durch Big-Tech-Unternehmen möglich wird, zu trainieren.
...
> Wenn der Stillstand aufgehoben wird, würden diese Hardware-Verbesserungen sofort für das Training leistungsfähigerer Modelle zu niedrigeren Kosten verfügbar werden - ein Hardware-Überhang.
...
Allerdings haben wir in dem schlimmsten Fall, in dem wir ihre Sicherheit nicht gewährleisten können und nicht genug bei der Ausrichtung vorankommen, immer noch die Option, unsere Intelligenz durch andere Technologien zu erweitern.
...
Ein ausreichend leistungsfähiges schmales Modell (das auf realen Daten trainiert wurde) könnte wahrscheinlich auf gefährliche Fähigkeiten verallgemeinert werden.
