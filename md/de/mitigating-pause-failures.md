...
Unserer Meinung nach ist die Wahrscheinlichkeit, dass KI katastrophale Risiken verursacht, bereits groß genug, um einen Stillstand zu rechtfertigen.
Wie Stuart Russell sagte, sollte man bei einem ungewissen Zeitplan die Aktion wählen, die optimal wäre, wenn man den kürzesten Zeitraum betrachtet.
...
Der Stillstand, den wir vorschlagen, ist von unbestimmter Länge. Wir sollten nicht wieder aufhören, bis es einen ausreichenden Konsens gibt, dass wir wissen, wie man sichere KI entwickelt, egal wie leistungsfähig sie ist, und dass wir die Systeme haben, um es sorgfältig und demokratisch zu tun.
Es ist NICHT wie der [sechsmonatige Stillstand, den der offene Brief des Future of Life Institute fordert](https://futureoflife.org/open-letter/pause-giant-ai-experiments/).

## Zu langer Stillstand {#pausing-for-too-long}

Nick Bostrom, einer der ersten KI-Alarmisten, befürchtet, dass [wir uns zu sehr um KI-Risiken sorgen könnten](https://twitter.com/jachaseyoung/status/1723325057056010680), obwohl dieser Moment noch nicht gekommen ist.
Wenn die Besorgnis um KI weiter steigt und wir einen Stillstand erreichen, könnte es zu einer Situation kommen, in der die gesamte KI-Entwicklung tabuisiert oder illegal wird.
...
Wie wir sagten, schlagen wir vor, dass die KI-Entwicklung wieder aufgenommen werden sollte, wenn es möglich wird, sichere KI zu entwickeln.
...
Die Entscheidung, ob ein CERN-/Apollo-/Manhattan-Projekt gut oder schlecht wäre, sollte multilateral diskutiert werden, sobald wir bereits in einem Stillstand zusammengearbeitet haben und außerhalb eines Wettrennens sind.
...
Aber was wir fordern, ist ein Stillstand, bis wir beweisen können, dass KI sicher entwickelt werden kann, also sollten wir nicht mit Organisationen enden, die unsichere KI entwickeln, nachdem der Stillstand aufgehoben wurde.
...
Da die physische Infrastruktur, die zum Trainieren eines großen Modells erforderlich ist, schwer zu verbergen ist, können wir die Entwicklung von KI in großem Umfang erkennen.
...
Nicht-staatliche Akteure sind unwahrscheinlich, dass sie ausreichende Ressourcen in Geheimheit sammeln können, um ein AGI zu trainieren, zumindest ein Jahrzehnt nachdem AGI durch große Technologieunternehmen möglich wird.
Außerdem würde die Tatsache, dass es keinen Geschäftsanreiz mehr gibt, dazu beitragen, die Menge an Untergrund-KI-Entwicklung zu reduzieren.
...
> Wenn der Stillstand aufgehoben wird, würden diese Hardware-Verbesserungen sofort für das Training leistungsfähigerer Modelle verfügbar werden - ein Hardware-Überhang.
...
Außerdem, wie wir sagten, sollte die "Play"-Taste nicht gedrückt werden, wenn wir immer noch nicht wissen, wie man sichere KI entwickelt.
...
Die Durchsetzung einer Obergrenze für Fähigkeiten ist schwierig, da es schwer vorherzusagen ist, welche Fähigkeiten ein Modell vor dem Training hat.
...
Wir möchten gefährliche Modelle einschränken, die [gefährliche Fähigkeiten](/dangerous-capabilities) haben, wie die Manipulation von Menschen, strategisches Planen und das Schreiben von Code.
...
- Ein nationaler Stillstand, der es potenziell schlimmeren Akteuren ermöglichen würde, als erste AGI zu erreichen
- Ein internationaler Stillstand, der nicht ordnungsgemäß durchgesetzt wird, was zu einem ähnlichen Ergebnis führen würde
