...
**Wir verstehen die internen Abläufe großer KI-Modelle nicht, können nicht vorhersagen, was sie tun können, wenn sie größer werden, und können ihr Verhalten nicht kontrollieren.**
...
Aktuelle "Frontier"-KI-gesteuerte LLMs (z.B. GPT4, Claude3, Gemini usw.) haben [Hunderte von Milliarden von "Parametern"](https://en.wikipedia.org/wiki/Large_language_model#List). Diese "Parameter" werden als ähnlich wie "Synapsen" im menschlichen Gehirn betrachtet.  Also werden GPT4-große Modelle voraussichtlich 1% der Größe eines menschlichen Gehirns haben.
...
> "Wenn die Rate des Wandels anhält, denke ich, dass 2029 oder vielleicht 2030 der Punkt ist, an dem die digitale Intelligenz wahrscheinlich die gesamte menschliche Intelligenz übertrifft." -- Elon Musk [AGI bis 2029? Elon Musk über die Zukunft der KI](https://youtu.be/DSKxmvq9t04?t=106)

## Unkontrollierbares Skalieren {#uncontrollable-scaling}

Sobald diese Systeme die gleiche Größe und Geschwindigkeit wie ein menschliches Gehirn (oder viel größer) erreichen, werden sie voraussichtlich in der Lage sein, "alle Aufgaben, die ein Experte menschliches Gehirn erledigen kann", auszuführen.
