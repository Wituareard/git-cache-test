...
Bis vor kurzem wurden die meisten KI-Systeme von Menschen entworfen, indem sie Software schrieben. Sie bestanden aus einem Satz von Regeln und Anweisungen, die von Programmierern geschrieben wurden.
...
Wir sind alle sehr vertraut mit den Fähigkeiten menschlicher Gehirne, da wir sie ständig um uns herum sehen. Aber die (oft überraschenden und emergenten) Fähigkeiten dieser neuen "digitalen Gehirne" (Deep-Learning-Systeme, LLMs usw.) sind schwer vorherzusagen und zu kennen.
...
Aktuelle "Frontier"-KI-gesteuerte LLMs (z.B. GPT4, Claude3, Gemini usw.) haben [100 Milliarden "Parameter"](https://en.wikipedia.org/wiki/Large_language_model#List). Diese "Parameter" gelten als irgendwie analog zu "Synapsen" im menschlichen Gehirn. Also werden GPT4-große Modelle voraussichtlich 1% der Größe eines menschlichen Gehirns haben.
