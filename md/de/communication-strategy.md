...
- **Kein KI-generierter Inhalt**. Die Verwendung von KI-Modellen ist in Ordnung für Recherche, Ideenfindung und Iteration von Ideen, aber veröffentlichen Sie keinen KI-generierten Inhalt als unseren eigenen - insbesondere keine KI-generierten Bilder oder Videos. Selbst wenn wir nicht gegen KI sind, können wir leicht als Heuchler bezeichnet werden, wenn wir klar KI-generierten Inhalt verwenden.
